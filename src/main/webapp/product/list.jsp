                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        ...
                                        <h2>$56</h2>
                                        <p>${product.getName()}</p>
                                        <a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i><a href="${pageContext.request.contextPath}/home?action=update&id=${product.getId()}&name=${product.getName()}&price=${product.getPrice()}&description=${product.getDescription()}">Update</a></a>
                                    </div>
